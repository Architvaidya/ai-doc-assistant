...
public class AssistantCommand {
    ...
    @Value("classpath:/prompts/doc-reference.st")
    private Resource sbPromptTemplate;

    public AssistantCommand(ChatClient chatClient, VectorStore vectorStore) {
        this.chatClient = chatClient;
        this.vectorStore = vectorStore;
    }

    @Command(command = "q")
    public String question(@DefaultValue(value = "What is this documentation about?") String message) {
